...
set SQLITE_H=bin\sqlite3.h
set SQLITE_LIB=bin\sqlite3.lib
set WKHTMLTOPDF_EXE=bin\wkhtmltopdf.exe
set DOC_PDF=doc\Salary Slip Generator Documentation.pdf
...
pyinstaller --onefile main.py ^
  --name App.exe ^
  --noconsole ^
  --add-binary "bin/wkhtmltopdf.exe;./bin" ^
  --add-data "doc;./doc" ^
  --add-data "html;./html" ^
  --add-data "json;./json" ^
