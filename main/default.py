...
<body>
    ...
    <table class="table">
        <tr><td>
            <table class="section left">
                <tr>
                    <td>Emp Code: <span>{{hr_emp}}</span></td>
                </tr>
                <tr>
                    <td>Branch: <span>Sion</span></td>
                </tr>
                <tr>
                    <td>Designation: <span>{{design}}</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Date Of Joining: <span>{{doj}}</span></td>
                </tr>
                
                <tr>
                    <td>Salary A/C No.: <span>{{a/c}}</span></td>
                </tr>
        ...
        <table class="section right">
            ...
            <tr>
                <td>Aadhar Card No: <span>{{aadhar}}</span></td>
            </tr>
            <tr>
                <td>PF No.: <span>{{pf}}</span></td>
            </tr>
            <tr>
                <td>UAN No: <span>{{una}}</span></td>
            </tr>
            <tr>
                <td>Scale: <span>{{scale}}</span></td>
            </tr>

            <tr>
                <td>Total Days Present: <span>{{present}}</span></td>
            </tr>
        </table>
    ...
    <table class="table">
        ...
        <table class="section left">
                ...
                <tr>
                    <td>Basic Pay</td>
                    <td><span>{{org_basic}}</span></td>
                </tr>
                <tr>
                    <td>Present Basic</td>
                    <td><span>{{basic_sal}}</span></td>
                </tr>
                <tr>
                    <td>DP / GP</td>
                    <td><span>{{agp/gp}}</span></td>
                </tr>
                <tr>
                    <td>DA</td>
                    <td><span>{{da}}</span></td>
                ...
                <tr>
                    ...
                    <td><span>{{arrers}}</span></td>
                </tr>
                <tr>
                    <td>Exam Remuneration</td>
        ...
        <table class="section right">
            ...
            <tr>
                ...
                <td><span>{{prof}}</span></td>
            </tr>
            <tr>
                <td>PF Amount</td>
                <td><span>{{pf_amount}}</span></td>
            </tr>
            <tr>
                <td>TDS</td>
                <td><span>{{tds}}</span></td>
            ...
            <tr>
                ...
                <td><span>{{diwali}}</span></td>
            </tr>
            <tr>
                <td>STAFF LOAN / ADVANCE</td>
                <td><span>{{staff_loan}}</span></td>
            </tr>
            <tr>
                <td>ADVANCE / MEDICAL</td>
                <td><span>{{med}}</span></td>
            </tr>
            <tr>
                <td>KJ SOMAIYA CREDIT SOC1TY LTD</td>
                <td><span>{{kjsieit}}</span></td>
            </tr>
            <tr>
                <td>Any Other Deduction</td>
                <td><span>{{other_ded}}</span></td>
            </tr>
            </table>
    ...
    <table class="table">
        ...
        <table class="section left">
            <tr>
                <td>Gross Salary: <span>{{gross}}</span></td>
            </tr>
            <tr>
                <td>Total Earnings: <span>{{net_salary}}</span></td>
            </tr>
        </table>
        </td>
        <td>
            <table class="section right">
                <tr>
                    <td>Total Deductions: <span>{{total_ded}}</span></td>
                </tr>
            <tr><td style="color:white">hidden</td></tr>
...
DEFAULT_TEACHING_JSON = {
    ...
    "tds": "TDS",
    "lic": "LIC",
    "staff_loan": "STAFF LOAN / DIWALI FESTIVAL /Festival Advance",
    "diwali": "STAFF ADVANCE /Advance To Employees /staff",
    "advance_staff": "STAFF ADVANCE /Advance To Employees /staff",
    "med": "Medical Policy Mar 20 to Feb  21",
    "kjsieit": "KJSIEIT EMPOYEES CO-OP CREDIT SOCITY LTD",
    "union": "Union Fees",
    "other_ded": "Other Deducation",
    ...
    "a/c": "SALARY A/C NO",
    "scale": "SCALE",
    "personal": "PERSONAL LOAN/Staff Loan From Bank",
    "other": "EXAM REM / OTHER",
    "pf_amount": "PF Rs780/ to1800 from sep 2014, for may 20. 10% lockdown"
}
