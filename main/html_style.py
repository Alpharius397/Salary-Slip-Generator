...
def DATA_CONTENT(month:str,year:str,emp_data:dict) -> str:
    return f"""
        <p>Payslip for the month of <span>{month.capitalize()}</span> <span>{year}</span></p>
    </div>
    ...
    <table class="table">
        <tr><td>
            <table class="section left">
                <tr>
                    <td>Emp Code: <span>{emp_data['hr_emp']}</span></td>
                </tr>
                <tr>
                    <td>Branch: <span>Sion</span></td>
                </tr>
                <tr>
                    <td>Designation: <span>{emp_data['design']}</span></td>
                </tr>
                <tr>
                    <td>PAN: <span>{emp_data['pan']}</span></td>
                </tr>
                
                <tr>
                    <td>Date Of Joining: <span>{emp_data['doj']}</span></td>
                </tr>
                
                <tr>
                    <td>Salary A/C No.: <span>{emp_data['a/c']}</span></td>
                </tr>
        ...
        <table class="section right">
            ...
            <tr>
                <td>Total Days Present: <span>{emp_data['present']}</span></td>
            </tr>
        </table>
    ...
    <table class="table">
        ...
        <table class="section left">
                ...
                <tr>
                    <td>DA</td>
                    <td><span>{emp_data['da']}</span></td>
                </tr>
                <tr>
                    <td>HRA</td>
                    <td><span>{emp_data['hra']}</span></td>
                </tr>
                <tr>
                    <td>CLA</td>
                    <td><span>{emp_data['cla']}</span></td>
                </tr>
                <tr>
                    <td>TA</td>
                    <td><span>{emp_data['ta']}</span></td>
                </tr>
                <tr>
                    <td>Special Allowance</td>
                    <td><span>{emp_data['arrers']}</span></td>
                </tr>
                <tr>
                    <td>Other</td>
                    <td><span>{emp_data['other']}</span></td>
                </tr>
        ...
        <table class="section right">
            ...
            <tr>
                ...
                <td><span>{emp_data['prof']}</span></td>
            </tr>
            <tr>
                <td>PF Amount</td>
                <td><span>{emp_data['pf_amount']}</span></td>
            </tr>
            <tr>
                <td>TDS</td>
                <td><span>{emp_data['tds']}</span></td>
            </tr>
            <tr>
                <td>LIC</td>
                <td><span>{emp_data['lic']}</span></td>
            </tr>
            <tr>
                <td>Personal Loan</td>
                <td><span>{emp_data['personal']}</span></td>
            </tr>
            <tr>
                <td>Diwali Advance / Other</td>
                <td><span>{emp_data['diwali']}</span></td>
            </tr>
            <tr>
                <td>STAFF LOAN / ADVANCE</td>
                <td><span>{emp_data['staff_loan']}</span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><span>{emp_data['other_ded']}</span></td>
            </tr>
            </table>
    ...
    <table class="table">
        ...
        <table class="section left">
            <tr>
                <td>Gross Salary: <span>{emp_data['gross']}</span></td>
            </tr>
            <tr>
                <td>Total Earnings: <span>{emp_data['net_salary']}</span></td>
            </tr>
        </table>
        </td>
        <td>
            <table class="section right">
                <tr>
                    <td>Total Deductions: <span>{emp_data['total_ded']}</span></td>
                </tr>
            <tr><td style="color:white">hidden</td></tr>
